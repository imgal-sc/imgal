...
pub fn chan_2d<'a, T, A>(points: A, parallel: bool) -> Result<Array2<T>>
where
    A: AsArray<'a, T, Ix2>,
    T: 'a + AsNumeric,
{
...
pub fn graham_scan<'a, T, A>(points: A, parallel: bool) -> Result<Array2<T>>
where
    A: AsArray<'a, T, Ix2>,
    T: 'a + AsNumeric,
{
...
pub fn jarvis_march<'a, T, A>(points: A, parallel: bool) -> Result<Array2<T>>
where
    A: AsArray<'a, T, Ix2>,
    T: 'a + AsNumeric,
{
...
pub fn quickhull_3d<'a, T, A>(points: A, parallel: bool) -> Result<(Array2<T>, Array2<usize>)>
where
    A: AsArray<'a, T, Ix2>,
    T: 'a + AsNumeric,
{
...
///   the query point.
fn find_hull_tangent<'a, T, A>(query_point: [T; 2], hull: A) -> Result<usize>
where
    A: AsArray<'a, T, Ix2>,
    T: 'a + AsNumeric,
{
